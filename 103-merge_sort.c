...
/**
 * merge_sort_top_down - sorts top-dwon recursively
 * @arrat: the integer array to sort
 * @strat: the strat index
 * @stop: the output array
 * @new: the output array
 *
 * return: void.
 */
void merge_sort_yop_down(int *array, size_t start, size_t stop, int *new)
{
	size_t mid;
